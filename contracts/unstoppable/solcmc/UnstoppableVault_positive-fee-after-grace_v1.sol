...
import {ReentrancyGuard} from "../versions/lib/ReentrancyGuard.sol";
import {FixedPointMathLib} from "../versions/lib/FixedPointMathLib.sol";
import {Owned} from "../versions/lib/Owned.sol";
import {SafeTransferLib, ERC4626, ERC20} from "../versions/lib/ERC4626.sol";
import {Pausable} from "../versions/lib/Pausable.sol";
import {IERC3156FlashBorrower, IERC3156FlashLender} from "../versions/lib/IERC3156.sol";
...
contract UnstoppableVault is IERC3156FlashLender, ReentrancyGuard, Owned, ERC4626, Pausable {
    ...
    function flashFee(address _token, uint256 _amount) public view returns (uint256 fee) {
        ...
        if (block.timestamp < end && _amount < maxFlashLoan(_token)) {
            ...
            require(_amount > 0);
            assert(_amount.mulWadUp(FEE_FACTOR) > 0);
